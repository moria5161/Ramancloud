...
def main_content():
    ...
    st.markdown('''
        <div style="font-size: 24px; font-weight: bold;">RamanCloud is designed to be a user-friendly and powerful tool for spectral data processing and analysis, especially for Raman spectroscopy.</div>
        <div style="font-size: 20px; margin-top: 10px;">The platform is developed by the <a href="https://bren.xmu.edu.cn" target="_blank">Ren Research Group</a> in Xiamen University.</div>
