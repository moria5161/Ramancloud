...
import numpy as np
from net import Net
from tranier_zinc import Trainer
...
targ = 'energy'
seed = 25
loss_function = nn.L1Loss(reduce='mean')

train_data_path ="/data/garelee/qm9/QM9_MH/pt/train_dataset.pt"
val_data_path ="/data/garelee/qm9/QM9_MH/pt/val_dataset.pt"
test_data_path ="/data/garelee/qm9/QM9_MH/pt/test_dataset.pt"
optimizer = 'AdamW'
