...
2. Installing the ALRMA Package

A. Change to the directory that contains the file setup.py and the subdirectory ALRMA. If 
...
3. Using the ALRMA Package

The ALRMA package is on your Python path. To import it into a Python script or session, 
execute:
